...
public class ZooKeeperEmbedded {
    ...
    public ZooKeeperEmbedded(int port) throws Exception {
        this.server = new TestingServer(port, false);
    }
    ...
    public void start() throws Exception {
        log.debug("Starting embedded ZooKeeper server at {} ...", server.getConnectString());
        server.start();
        log.debug("Startup of embedded ZooKeeper at {} completed ...", server.getConnectString());
    }
